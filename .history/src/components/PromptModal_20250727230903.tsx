...
export default function PromptModal({ prompt, isOpen, onClose }: PromptModalProps) {
  ...
  return (
    <div 
      className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-gray-900/50 dark:bg-black/60 backdrop-blur-sm"
      onClick={onClose}
    >
      <div 
        className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden transition-all duration-300 ease-in-out transform scale-95 opacity-0 animate-fade-in-scale"
      ...
      >
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-80px)] custom-scrollbar">
          ...
          <div className="p-6 border-b border-gray-100 dark:border-gray-700">
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{prompt.title}</h1>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-3">{prompt.description}</p>
          ...
          <div className="pt-0 px-6 pb-6">
            <div className="rounded-lg overflow-hidden relative">
              ...
              <div className="p-0">
                <div className="text-sm leading-relaxed text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700 min-h-[200px] max-h-[50vh] overflow-y-auto custom-scrollbar prose prose-sm dark:prose-invert max-w-none">
                  <ReactMarkdown 
